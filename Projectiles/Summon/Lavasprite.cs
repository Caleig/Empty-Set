...
namespace EmptySet.Projectiles.Summon
{
    ...
    /// 熔岩灵
    /// </summary>
    public class Lavasprite : ModProjectile
    {
        int Attacktimer = 0;
        ...
        public override void AI()
        {
            ...
            if (!owner.armor.Any(x => x.type == ModContent.ItemType<BurnHellTalisman>()))
            {
                Projectile.Kill();
            }
        ...
        private void Movement(bool foundTarget, float distanceFromTarget, Vector2 targetCenter, float distanceToIdlePosition, Vector2 vectorToIdlePosition)
        {
            ...
            if (foundTarget && Attacktimer >= 90)
            {
                // 小黄人有一个目标:攻击
                Vector2 Attack = Vector2.Normalize(targetCenter - Projectile.Center) * 15;
                Projectile.NewProjectile(Entity.GetSource_FromAI(), Projectile.Center, Attack, ModContent.ProjectileType<MiniFireballGunProj>(), 40, 3);
                Attacktimer = 0;
            }
            else
            {
        ...
        private void Visuals()
        {
            ...
            // 一些视觉效果
            Lighting.AddLight(Projectile.Center, Color.Red.R / 100, Color.Red.G / 100, Color.Red.B / 100);
        }
    }
}
