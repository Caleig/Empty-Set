...
/// 永夜回飞刃弹幕
/// </summary>
public class NightsFlyBackBladeProj : ModProjectile
{
    ...
    {
        var dust = Dust.NewDustDirect(Projectile.position,
            Projectile.width, Projectile.height, DustID.PurpleTorch);
        dust.noGravity = true;
		...
		if (Projectile.ai[0] == 0f)
		{
			...
			if (Projectile.ai[1] >= 40f || Projectile.penetrate == 1)
			{
				Projectile.ai[0] = 1f;
				Projectile.ai[1] = 0f;
