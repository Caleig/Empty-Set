...
/// 邪炎弹幕
/// </summary>
public class EvilFireProj : ModProjectile
{
    public override void SetStaticDefaults()
    {
        ProjectileID.Sets.TrailCacheLength[Projectile.type] = 7; // 要记录的旧位置长度
	...
	{
        var dust = Dust.NewDustDirect(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.CursedTorch, Scale: Main.rand.NextFloat(1f, 2f));
	...
	public override bool OnTileCollide(Vector2 oldVelocity)
	{
        ...
        {
            if (hit.Crit) target.AddBuff(BuffID.CursedInferno, 120);
