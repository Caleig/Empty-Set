...
/// 匣子
/// </summary>
public class JungleHunterChestPlaced : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<JungleHunterChestTile>();
    }

    public override void AddRecipes() => CreateRecipe()
        .AddIngredient(ModContent.ItemType<JungleHunterChest>(),1)
