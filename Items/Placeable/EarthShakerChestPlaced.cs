...
/// 匣子
/// </summary>
public class EarthShakerChestPlaced : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<EarthShakerChestTile>();
    }

    public override void AddRecipes() => CreateRecipe()
        .AddIngredient(ModContent.ItemType<EarthShakerChest>(),1)
